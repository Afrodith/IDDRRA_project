...
{ 
  fpDirectory = new G4UIdirectory("/IDDRRA/");
  fpDirectory->SetGuidance("UI commands of this example");

  fpDetDirectory = new G4UIdirectory("/IDDRRA/det/");
  fpDetDirectory->SetGuidance("Detector construction control");

  fpLoadPdbCmd = new G4UIcmdWithAString("/IDDRRA/det/loadPDB",this);
  ...
  fpDrawAtoms = new G4UIcmdWithoutParameter("/IDDRRA/det/drawAtoms",this);
  ...
  fpDrawNucleotidesWithBounding = new G4UIcmdWithoutParameter(
      "/IDDRRA/det/drawNucleotidesWithBounding",
      this);
  ...
  fpDrawResiduesWithBounding = new G4UIcmdWithoutParameter(
      "/IDDRRA/det/drawResiduesWithBounding",
      this);
