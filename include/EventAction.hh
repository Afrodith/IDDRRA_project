...
public:
  ...
  G4String outputFile;
  QString datOutputFile();

  void AddEdepEvent(G4double edep){
    fTotalEnergyDeposit += edep;
    //G4cout << edep << "   	" << fTotalEnergyDeposit << G4endl;
  };
  ...
  void AddEdepToNucleotide(G4int numStrand,G4int numNucl,G4double edep)
  {
    ...
    //G4cout << "strandID=" << numStrand << " 	nuclID=" << numNucl << " 	edep=" << fEdepStrand1[numNucl];
  }
...
private:
  ...
  std::map<G4int,G4double>::iterator it1, it2, it3, it4, it5, it6, it7;
